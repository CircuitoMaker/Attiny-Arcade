...
void loop() { 
  delay(40);
      ...
      ssd1306_char_f6x8(18, 1, "  P A R E D A O");  
      ssd1306_char_f6x8(14, 3, "Circuito Maker");
      delay(500);
      ssd1306_char_f6x8(16, 5, "Attiny Arcade");  
    ...
    while (1==1) {
              ...
              if (lastFrame+10<millis()){
                if(bally>10&&bally+vdir>=54&&(ballx<player||ballx>player+platformWidth)){ // game over if the ball misses the platform
                  ...
                  ssd1306_fillscreen(0x00);                
                  ssd1306_char_f6x8(30, 1, "Game Over");
                  ssd1306_char_f6x8(30, 3, "Score:");
                  char temp[4] = {0,0,0,0};
                  itoa(score,temp,10);
                  ssd1306_char_f6x8(70, 3, temp);
                  ssd1306_char_f6x8(30, 5, "Top Score:");
                  itoa(topScore,temp,10);
                  ssd1306_char_f6x8(94, 5, temp);
                ...
                else if (ballx<player+platformWidth/2&&bally>10&&bally+vdir>=54){ // Se a bola bate à esquerda da plataforma vai para a esquerda
                  hdir=-1; beep(20,600);
                }else if (ballx>player+platformWidth/2&&bally>10&&bally+vdir>=54){  // Se a bola bate à direita da plataforma vai para a direita
                  hdir=1; beep(20,600);
...
void resetGame(){
  ssd1306_char_f6x8(20, 1, "P A R E D A O");
  ssd1306_char_f6x8(18, 4, "Circuito Maker");
    delay(200);
  ssd1306_char_f6x8(20, 6, "Attiny Arcade");  
